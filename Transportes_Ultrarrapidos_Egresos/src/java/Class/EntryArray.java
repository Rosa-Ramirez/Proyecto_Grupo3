...
public class EntryArray {
    ...
    public String registerEntry(Entry entry){        
        ...
        try{
            ...
            statement.setString(4, entry.getDestiny());
    ...
    public void getEntry(StringBuffer respuesta){   
        String sql="select * from transportes_ultrarrápidos_sa.registro_egreso";
        try{
        openConnection();
        ...
        resultSet = statement.executeQuery();            
            if (resultSet!=null){
                ...
                respuesta.append("<tr>");
                respuesta.append("<td >").append(resultSet.getString("id_Registro_Egreso")).append("</td>");
                ...
                respuesta.append("<td >").append(resultSet.getString("Destino")).append("</td>");
                respuesta.append("<td >").append(resultSet.getString("Tipo_Carga")).append("</td>");
                respuesta.append("<td id=\"").append(resultSet.getString("id_Registro_Egreso"))
        ...
        String sql = "DELETE FROM registro_egreso WHERE id_Registro_Egreso = "+idRegister;
        try{
            openConnection();
            statement = connection.prepareStatement(sql);
            int resultado = statement.executeUpdate();
