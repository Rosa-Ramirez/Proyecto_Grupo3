<%-- 
    Document   : ReportEgress
    Created on : 28/10/2022, 11:55:13
    Author     : ramir
--%>
...
<html>
          ...
          <body>
                                                  ...
                                                  <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                                            <ul class="navbar-nav m-auto">
                                                                      ...
                                                                      <li class="nav-item dropdown">
                                                                                ...
                                                                                <ul class="dropdown-menu dropdown-menu-dark" id="menu-navbar2">                                                              
                                                                                          <li><a class="dropdown-item" href="Report.jsp">Reporte Tansportista</a></li>
                    ...
                    <%
                              ...
                              rs = smt.executeQuery("SELECT * FROM transportes_ultrarrapidos_sa.registro_egreso");
                    %>
                    <div class="container mx-auto">
                              <div class="d-flex justify-content-end mx-5 my-4">
                                        <form class="d-flex" role="search">
                                                  <input class="form-control me-2" type="time" name="txtTime">
                                                  <input class="form-control me-2" type="text" name="txtDay">
                                        ...
                                        <%
                                                  ...
                                                  if (nameSearch != null) {
                                                            smt = conn.connection().createStatement();
                                                            rs = smt.executeQuery("SELECT * FROM transportes_ultrarrapidos_sa.registro_egreso WHERE hora LIKE" + " '%" + nameSearch + "%' AND dia LIKE" + " '%" + daySearch +"%' " );
                                                  } else {
                                                            System.err.print("Error");
                                                  }
                                        %>
                              </div>
                              <a href="EgressForm.jsp" class="btn btn-outline-dark text-white">Nuevo Registro</a>
                              <c:if test="${error ==1}">
                              ...
                              <div class="table-responsive mx-4 my-4">
                                        <table class="table table-hover table-dark">
                                                  ...
                                                  %>
                                                  <tr>
                                                            <td><%= rs.getString("id_registro_egreso")%></td>
