          ...
          <body>
                              ...
                              <div id="carouselExampleDark" class="carousel carousel-dark slide" data-bs-ride="carousel" >
                                        ...
                                        <div class="carousel-inner" id="carousel"  >
                                                  <div class="carousel-item active" id="sims" data-bs-interval="10000">
                                                            ...
                                                            <img src="./images/1_vision.png" class="d-block w-100 center-block" alt="vision">
                                                            </a>
                                                  </div>
                                                  <div class="carousel-item" id="fallGuys" data-bs-interval="2000">
                                                            <img src="./images/2_mision.png" class="d-block w-100" alt="mision">
                                                  </div>
                                                  <div class="carousel-item" id="heavyRain">
                                                            <img src="./images/3_valores.png" class="d-block w-100" alt="valores">
                                                  </div>
                                                  <div class="carousel-item" id="amongUs">
                                                            <img src="./images/4.png" class="d-block w-100" alt="transporte">
                                                  </div>
                                                  <div class="carousel-item" id="amongUs">
                                                            <img src="./images/5.png" class="d-block w-100" alt="seguridad">
                                                  </div>
                                        </div>
                    ...
                    <footer class="text-center text-white" id="foot">
                              ...
                              <div class="container p-4">
                                        ...
                                        <section class="mb-4">
                                                  <h3>
                                                            "Los más rápidos de Centroamérica"
                                                  </h3>
                                                  <p>
                                                            Contáctanos:
                                                  </p>
                                        ...
                                        <section class="mb-4">
                                                  <!-- Facebook -->
                                                  <a class="btn btn-outline-light btn-floating m-1" href="https://www.facebook.com/rosy.ramirezespinoza" role="button" target="_blank" >
                                                  ...
                                                  <a class="btn btn-outline-light btn-floating m-1" href="https://twitter.com/RoussGT_23"  role="button" target="_blank">
                                                  ...
                                                  <a class="btn btn-outline-light btn-floating m-1" href="https://www.instagram.com/reespinoza_17" role="button" target="_blank" >
                                                  ...
                                                  <a class="btn btn-outline-light btn-floating m-1" href="https://t.me/rous_2309" role="button" target="_blank" ><i class="fab fa-telegram">
                                                  ...
                                                  <a class="btn btn-outline-light btn-floating m-1" href="https://github.com/Rosa-Ramirez/Proyecto_Grupo3.git" role="button" target="_blank" >
